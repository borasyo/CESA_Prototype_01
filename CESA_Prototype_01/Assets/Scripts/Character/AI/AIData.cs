...
public class AIData : MonoBehaviour
{
    ...
    public void Set()
    {
        _RatioDataWeak   = new RatioData[(int)Character.eCharaType.MAX];
        _RatioDataNormal = new RatioData[(int)Character.eCharaType.MAX];
        _RatioDataStrong = new RatioData[(int)Character.eCharaType.MAX];
        _RiskDataWeak    = new RiskData [(int)Character.eCharaType.MAX];
        _RiskDataNormal  = new RiskData [(int)Character.eCharaType.MAX];
        _RiskDataStrong  = new RiskData [(int)Character.eCharaType.MAX];

        //  Balance
        #region Balance
        int b = (int)Character.eCharaType.BALANCE;
        ...
        //  Power
        #region Power
        int p = (int)Character.eCharaType.POWER;
        ...
        //  Speed
        #region Speed
        int s = (int)Character.eCharaType.SPEED;
        ...
        //  Technical
        #region Technical
        int t = (int)Character.eCharaType.TECHNICAL;
    ...
    public int[] GetRatio(int level, Character.eCharaType type, bool isSpecial)
    {
        int[] ratio = new int[4];
        int idx = (int)type;
    ...
    public RiskData GetRisk(int level, Character.eCharaType type)
    {
